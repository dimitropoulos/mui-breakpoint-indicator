...
exports.BreakpointHelper = (_a) => {
    var { visible = true } = _a, rest = __rest(_a, ["visible"]);
    return (visible ? React.createElement(InternalBreakpointHelper, Object.assign({}, rest)) : null);
};
const InternalBreakpointHelper = ({ position: suppliedPosition }) => {
