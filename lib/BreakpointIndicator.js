...
const InternalBreakpointIndicator = ({ className = '', position: suppliedPosition, style = {}, }) => {
    ...
    return (react_1.default.createElement("div", { className: className, onClick: onClick, style: Object.assign(Object.assign({ backgroundColor, border: `2px solid ${color}`, color, cursor: 'pointer', padding: '0 1em', position: 'fixed', zIndex: 99999 }, placementsByPosition[position]), style) }, breakpoint));
};
exports.BreakpointIndicator = (_a) => {
    var { visible = true } = _a, rest = __rest(_a, ["visible"]);
    return (visible ? react_1.default.createElement(InternalBreakpointIndicator, Object.assign({}, rest)) : null);
};
