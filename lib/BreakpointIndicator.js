...
const useWidth = () => {
    ...
    return ((_a = (0, ramda_1.reduce)((accumulator, breakpoint) => {
        // eslint-disable-next-line react-hooks/rules-of-hooks -- see above
        const matches = (0, material_1.useMediaQuery)(theme.breakpoints.up(breakpoint));
        return accumulator === null && matches ? breakpoint : accumulator;
    }, null, (0, ramda_1.reverse)(theme.breakpoints.keys))) !== null && _a !== void 0 ? _a : 'xs');
};
...
const InternalBreakpointIndicator = ({ className = '', position: suppliedPosition, style = {}, }) => {
    ...
    const backgroundColor = (0, polished_1.hsl)(hue, 0.75, 0.5);
    const color = (0, polished_1.readableColor)(backgroundColor);
    const onClick = event => {
