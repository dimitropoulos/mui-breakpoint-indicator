...
const InternalBreakpointIndicator = ({ className = '', position: suppliedPosition, style = {}, }) => {
    ...
    return (React.createElement("div", { onClick: onClick, className: className, style: Object.assign(Object.assign({ backgroundColor, border: `2px solid ${color}`, color, padding: '0 1em', position: 'fixed', cursor: 'pointer', zIndex: 99999 }, placementsByPosition[position]), style) }, breakpoint));
};
